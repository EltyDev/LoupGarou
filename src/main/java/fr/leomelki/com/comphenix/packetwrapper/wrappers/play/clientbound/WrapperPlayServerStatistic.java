...
import fr.leomelki.com.comphenix.packetwrapper.wrappers.play.serverbound.WrapperPlayClientClientCommand;

import java.util.Map;

/**
 * Sent as a response to @link{{@link WrapperPlayClientClientCommand}}. Will only send the changed values if previously requested.
 */
