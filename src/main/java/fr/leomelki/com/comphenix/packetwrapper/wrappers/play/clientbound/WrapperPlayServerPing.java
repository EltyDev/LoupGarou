...
import fr.leomelki.com.comphenix.packetwrapper.wrappers.play.serverbound.WrapperPlayClientPong;

/**
 * Send from server to client. The client should respond with the same ID using {@link WrapperPlayClientPong}.
